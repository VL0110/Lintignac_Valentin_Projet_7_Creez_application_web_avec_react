// Importation arrow, react use et styles 

import React, { useEffect, useState } from 'react'
import styled from 'styled-components'
import resolution from '../../utils/hooks/resolution'
import RightArrowImg from '../../assets/right-arrow.png'
import RightArrowSmImg from '../../assets/right-arrow-tel.png'
import LeftArrowImg from '../../assets/left-arrow.png'
import LeftArrowSmImg from '../../assets/left-arrow-tel.png'
import { fadeIn } from '../../utils/animation'
import { useWindowSize } from '../../utils/hooks'

// Définition style cover, arrow, picture, media only (tel)
...
// Appel "const" CoverImage avec les éléments de la section de la page (useEffect, slide, arrow)
