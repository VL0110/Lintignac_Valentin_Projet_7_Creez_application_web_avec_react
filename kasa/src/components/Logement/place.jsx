...
// Définition style title, location, tagsUl, tags,  media only (tel)
...
// Appel "const" Place avec les éléments de la section de la page (title, location, tags)
