...
// Définition style profil, name, picture, media only (tel)
...
// Appel "const" Profil avec les éléments de la section de la page (profil,name,picture)
